...
public class C_LinkedPractice {
	public static void main(String[] args) {
		...
		boolean isLSAParticipating = event.checkParticipant("SJH");
		...
		System.out.println(isKJIParticipating);	// true
	}
}